<template>
  <div class="bg-white p-6 rounded">
    ...
    <p>These terms of service outline the rules and regulations for the use of Birthday app's Website.</p>
    
    <p>
      By accessing this website we assume you accept these terms of service in full. Do not continue to use Birthday app's website
      if you do not accept all of the terms of service stated on this page.
    </p>
    <p>
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Birthday app's website you consent to the use of cookies
      in accordance with Birthday app's privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Birthday app and/or it's licensors own the intellectual property rights for
      all material on Birthday app. All intellectual property rights are reserved. You may view and/or print
      pages from https://birthdays.techyfingers.com for your own personal use subject to restrictions set in these terms of service.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from https://birthdays.techyfingers.com</li>
      <li>Sell, rent or sub-license material from https://birthdays.techyfingers.com</li>
      <li>Reproduce, duplicate or copy material from https://birthdays.techyfingers.com</li>
    </ol>
    <p>Redistribute content from Birthday app (unless content is specifically made for redistribution).</p>
    ...
    <p>
      ...
      the visibility associated with the hyperlink outweighs the absence of Birthday app; and (d) where the
    ...
    <p>
      ...
      <a
        ...
        title="send an email to contact@techyfingers.com"
      >contact@techyfingers.com</a>.
    ...
    <p>
      No use of Birthday app's logo or other artwork will be allowed for linking absent a trademark license
      agreement.
    </p>
    ...
    <p>
      ...
      >privacytermsgenerator.com</a>. If you have
